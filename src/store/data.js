...
export const bios = [
  {
    ...
    desc: `Enthusiastic full-stack web developer proficient in creating captivating user interfaces and robust backend systems for
    web and mobile applications. Skilled in React.js and React Native for front-end development, with a keen eye for UI/UX design.
    Confident in backend development using Node.js, Express, and MongoDB. Committed to delivering polished and intuitive experiences
    while contributing effectively in collaborative environments.`,
